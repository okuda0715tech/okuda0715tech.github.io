...
- [結論](#結論)
- [UI → ViewModel は「起きたこと」](#ui--viewmodel-は起きたこと)
- [ViewModel → UI は「意図」](#viewmodel--ui-は意図)
- [実際に違和感が生まれた例](#実際に違和感が生まれた例)
- [「クリックされたもの」ではなく「やりたいこと」に着目する](#クリックされたものではなくやりたいことに着目する)
- [すべてを意図ベースにする必要はない](#すべてを意図ベースにする必要はない)
- [まとめ](#まとめ)
...
この方針を破ったほうが自然な名前になる場合も多々あることに注意してください。
