...
- [結論](#結論)
- [なぜそう考えたのか](#なぜそう考えたのか)
  - [ID は比較的「安定した概念」](#id-は比較的安定した概念)
- [本当に危険なのは「変化しやすいドメインモデル」](#本当に危険なのは変化しやすいドメインモデル)
- [一方、ID は変化しにくい](#一方id-は変化しにくい)
- [むしろ UI専用 ID を増やすデメリットもある](#むしろ-ui専用-id-を増やすデメリットもある)
- [UI とドメインの分離基準](#ui-とドメインの分離基準)
- [まとめ](#まとめ)
