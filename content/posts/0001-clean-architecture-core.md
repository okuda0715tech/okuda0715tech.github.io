+++
title = "Jetpack Compose で UI 状態を管理する方法"
date = 2026-01-14
tags = ["Android", "Compose", "UI"]
draft = false
+++

- [クリーンアーキテクチャの本質をわかりやすく解説](#クリーンアーキテクチャの本質をわかりやすく解説)
- [アーキテクチャとは](#アーキテクチャとは)
- [依存関係とは](#依存関係とは)
  - [物理的な依存関係](#物理的な依存関係)
  - [意味的な依存関係](#意味的な依存関係)
...
中心にあるのが、 ドメインモデル や エンティティ ではないでしょうか？
その一つ外側にあるのが、 ビジネスルール や ユースケース ではないでしょうか？
...
ご質問がございましたらコメントしていただけましたら、遅くなるかもしれませんが、できる限りお答えさせていただきます。
...
もし参考になりましたら、チーム内で知識の共有をしてみてください。
また、もしよろしければ「いいね」や「参考になった」というコメントもいただけますと、今後の励みになります。
